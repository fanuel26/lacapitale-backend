...
export default class DetailReservationRegistrationValidator {
  ...
  public schema = schema.create({
    id_vente: schema.number([rules.required()]),
    id_user: schema.number([rules.required()]),
    id_produit: schema.number([rules.required()]),
    qte: schema.number([rules.required()]),
    prix_total: schema.number([rules.required()]),
  })
